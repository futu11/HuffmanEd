...
extern void CodificaArvore(tNo *arv, int ar[], int aux, FILE* fp);
extern int CodificaLista(tNo *arv, char elemento, int aux, FILE* fp);
extern void EscreveArvore(char elemento, tNo *arv, FILE* fp);
